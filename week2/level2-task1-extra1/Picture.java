...
public class Picture
{
    ...
    private Circle apple7;
    private Circle apple8;
    ...
    public void newHouse(int distance){
            sky.moveHorizontal(distance);
            ...
            star1.moveHorizontal(distance);
            star2.moveHorizontal(distance);            
            star3.moveHorizontal(distance);
            star4.moveHorizontal(distance);
            star5.moveHorizontal(distance);
            star6.moveHorizontal(distance);
            star7.moveHorizontal(distance);
            star8.moveHorizontal(distance);
            star9.moveHorizontal(distance);
            star10.moveHorizontal(distance);
            star11.moveHorizontal(distance);
            star12.moveHorizontal(distance);
                      
            trunk.moveHorizontal(distance);
            leaves.moveHorizontal(distance);
            apple1.moveHorizontal(distance);
            apple2.moveHorizontal(distance);
            apple3.moveHorizontal(distance);
            apple4.moveHorizontal(distance);
            apple5.moveHorizontal(distance);
            apple6.moveHorizontal(distance);
            apple7.moveHorizontal(distance);
            apple8.moveHorizontal(distance);
    }
    ...
    public void day()
    {
        ...
        apple6.moveHorizontal(170);
        apple6.changeColor("red");
        apple6.makeVisible();
        
        apple7 = new Circle();
        apple7.changeSize(10);
        apple7.moveVertical(80);
        apple7.moveHorizontal(190);
        apple7.changeColor("red");
        apple7.makeVisible();
        
        apple8 = new Circle();
        apple8.changeSize(9);
        apple8.moveVertical(120);
        apple8.moveHorizontal(200);
        apple8.changeColor("red");
        apple8.makeVisible();
    ...
    public void regrowApple7() {
        apple7.makeInvisible();
        apple7.slowMoveVertical(-140);
        apple7.changeSize(0);
        apple7.makeVisible();
        for (int i = 0; i < 11; i++) {
            apple7.changeSize(i);
    ...
    public void regrowApple8() {
        apple8.makeInvisible();
        apple8.slowMoveVertical(-110);
        apple8.changeSize(0);
        apple8.makeVisible();
        for (int i = 0; i < 11; i++) {
            apple8.changeSize(i);
    ...
    public void dropapple7(){
        apple7.slowMoveVertical(140);
    }
    
    public void dropapple8(){
        apple8.slowMoveVertical(110);
    }
    ...
    public void sunrise() {
        ...
        apple7.changeColor("dullred");    
        apple8.changeColor("dullred");
