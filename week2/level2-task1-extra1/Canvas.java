...
public class Canvas
{
    ...
    public static Canvas getCanvas()
    {
        if(canvasSingleton == null) {
            canvasSingleton = new Canvas("BlueJ Shapes Demo", 1200, 300, 
                                         Color.white);
        }
    ...
    public void setForegroundColor(String colorString)
    {
        if(colorString.equals("red")) {
        ...
        else if(colorString.equals("grassgreen")) {
            graphic.setColor(new Color(1, 166, 17));
        }
            ...
            graphic.setColor(new Color(174,137,118));
        }
        else if(colorString.equals("darkgrey")) {
            graphic.setColor(new Color(79,102,121));
        }
        else if(colorString.equals("grey")) {
            graphic.setColor(new Color(109,126,140));
        }
        else if(colorString.equals("skyblue")) {
            graphic.setColor(new Color(153,204,255));
        }
        else if(colorString.equals("sunset")) {
            graphic.setColor(new Color(229,83,0));
        }
        else if(colorString.equals("orangered")) {
            graphic.setColor(new Color(255,92,0));
        }
        else if(colorString.equals("yellow")) {
            graphic.setColor(new Color(255,195,77));
        }
        else if(colorString.equals("sunsetred")) {
            graphic.setColor(new Color(245, 64, 64));
        }
        else if(colorString.equals("dullred")) {
            graphic.setColor(new Color(150, 0, 24));
        }
