...
public class Calculation
{
    ...
    public void executeAll(double x, double y, double xCelsius, double a, double b, double c, int z, String date, int value, int day, int  month, int year) {
        System.out.println("The input for x was: " + x + ", the input for y was: " + y);
        System.out.println();
        System.out.println("The following is the output from the 'getMaximumXY' method:");
        getMaximumXY(x, y);
        System.out.println("The following is the output from the 'getAverageXY' method:");
        getAverageXY(x, y);
         System.out.println("The following is the output from the 'swapXY' method:");
        swapXY(x, y);       
        System.out.println();
        System.out.println("The following is the output from the 'convertCelsiusToFarenheit' method:");
        System.out.println("The temperature input in Celsiuse was: " + xCelsius);
        convertCelsiusToFarenheit(xCelsius);
        System.out.println();
        System.out.println("The following is the output from the 'hoursInAWeek' method:");
        hoursInAWeek();
        System.out.println("The following is the output from the 'secondsInAYear' method:");
        secondsInAYear();
        System.out.println();
        System.out.println("The following is the output from the 'quadraticSolver' method:");
        System.out.println("The input for the coefficient of x^2 was: " + a + " the input for the coefficient of x was: " + b + " the input for the constant was: " + x);
        quadraticSolver(a, b, c);
        System.out.println();
        System.out.println("The following is the output from the 'isItOdd' method:");
        System.out.println("The input for the method was: " + z);
        isItOdd(z);
        System.out.println();
        System.out.println("The following is the output from the 'separateDate' method:");
        System.out.println("The input for the method was: " + date);
        separateDate(date);
        System.out.println();
        System.out.println("The following is the output from the 'minimumNumberOfCoins' method:");
        System.out.println("The input for the method was: " + value + " pence.");
        minimumNumberOfCoins(value);
        System.out.println();
        System.out.println("The following is the output from the 'getDayForDate' method:");
        System.out.println("The input date for the method was: " + day + "/" + month + "/" + year + ".");
        getDayForDate(day, month, year);
    }
    ...
    public void convertCelsiusToFarenheit (double x) {
        System.out.println("Temperature in Celsius is: " + x);
        y = 1.8*x + 32;
    ...
    public void minimumNumberOfCoins(int valueInPence)
    {
